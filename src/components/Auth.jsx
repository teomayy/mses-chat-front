...
const Auth = () => {
	...
	const handleSubmit = async e => {
		...
		const URL = 'https://localhost:443/auth'
	...
	const handleSendOtp = async () => {
		try {
			const res = await axios.post('https://localhost:443/auth/send-otp', {
	...
	const handleSendResetOtp = async () => {
		try {
			const res = await axios.post(
				'https://localhost:443/auth/send-reset-otp',
				{
					phoneNumber: form.phoneNumber,
				}
			)
	...
	const handleVerifyOtp = async () => {
		try {
			const response = await axios.post(
				'https://localhost:443/auth/verify-otp',
				{
					phoneNumber: form.phoneNumber,
					otp,
				}
	...
	const handleResetPassword = async () => {
		try {
			const response = await axios.post(
				'https://localhost:443/auth/reset-password',
				{
					phoneNumber: form.phoneNumber,
					otp,
					newPassword,
